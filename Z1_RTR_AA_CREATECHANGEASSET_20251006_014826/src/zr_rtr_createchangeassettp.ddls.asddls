...
define root view entity ZR_RTR_CreateChangeAssetTP
  as select from ztrtr_0066_a as CreateChangeAsset
...

{
  key asset_uuid                     as AssetUUID,
      ...
      asset_status_at_purchase       as AssetStatusAtPurchase,
      ...
      negative_amount_is_allowe15    as NegativeAmountIsAllowe15,
